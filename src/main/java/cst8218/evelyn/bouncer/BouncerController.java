...
import cst8218.evelyn.bouncer.util.JsfUtil;
import cst8218.evelyn.bouncer.util.PaginationHelper;
 ...
 * BouncerController is a NamedBean. It is part of the presentation layer along with the JSF Pages.
 * The majority of its methods allow the user to perform CRUD operations from the user interface.
...
public class BouncerController implements Serializable {
    ...
    @EJB
    private cst8218.evelyn.bouncer.BouncerFacade ejbFacade;
